...
(function () {
    ...
    function handleValues(values) {
            ...
            while (curHost < data.length && insertAt < data.length) {
                ...
                if (insertAt > curHost+1) {
                    ...
                    for (var m = 3; m < hostTotals.length; m++) {
                        var t = hostTotals[m];
                        hostTotalRow += '<td align="middle">' + getSize(t) + (m < 5 ? '/s' : '') + '</td>'
                    }
                    hostTotalRow += '</tr>';
        ...
        function handleRow(data) {
            ...
            // create displayData
            var displayData = [
                '<td align="middle" title="' + data[1] + '">' + data[0] + '<br />' + data[2] + '</td>',
                ...
                '<td align="middle">' + getDateString(data[6]) + '</td>',
                '<td align="middle">' + getDateString(data[7]) + '</td>'
            ];
