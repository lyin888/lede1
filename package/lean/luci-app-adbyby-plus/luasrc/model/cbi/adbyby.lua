...
s:tab("adlog",  translate("更新日志"))
log = s:taboption("adlog", TextValue, "sylogtext")
log.description = translate("先更新hosts，再更新adbyby规则")
...
function log.cfgvalue(self, section)
	return nixio.fs.readfile(adlog)
end

function log.write(self, section, value)
	value = value:gsub("\r\n?", "\n")
	nixio.fs.writefile(adlog, value)
end
